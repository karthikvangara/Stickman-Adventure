...
def pause_window(runs):
    ...
    level=font.render("Level 7",1,black)
...
background = pygame.image.load(os.path.join(r"level_7_images\Background.png"))
...
pipe2_rect=pygame.Rect(340,100,80,100)

star1_rect=pygame.Rect(500,425,star_width,star_height)
star2_rect=pygame.Rect(200,125,star_width,star_height)
star3_rect=pygame.Rect(1040,125,star_width,star_height)

pause_rect_hover = pygame.Rect(13, 18, play_width + 10, play_height + 10)

def window(pressed,count,star1,star2,star3):
    win = pygame.display.set_mode((win_width, win_height))
    pygame.display.set_caption("Stickman-----LEVEL-7")

    win.blit(background,(0,0))

    if count<90:
        level=level_font.render("LEVEL 7",1,black)
        sugg=font.render("Press UP arrow to travel through pipes",1,black)
        win.blit(level,(600,25))
        win.blit(sugg,(600,100))
        win.blit(font.render("Press DOWN arrow to travel through pipes",1,black),(600,125))
    count+=1
    ...
    if key_pressed[pygame.K_RIGHT] and stickman_rect.x+stickman_width < 1200 and stickman_rect.x > 0:
        ...
        if key_pressed[pygame.K_SPACE]:
            ...
            if (stickman_rect.x>1020 and stickman_rect.y==300) or (stickman_rect.x<500 and stickman_rect.x>340 and stickman_rect.y==0):
                pass
            else:
                stickman_rect.y += stickman_jump_height
        elif (stickman_rect.x+stickman_width<1020 and stickman_rect.y==300) or ((stickman_rect.x+stickman_width<340 or stickman_rect.x>500) and stickman_rect.y<20):
            stickman_rect.y+=stickman_jump_height
        elif stickman_rect.x>800 and stickman_rect.x+stickman_width<950 and stickman_rect.y==100:
            stickman_rect.x+=stickman_vel
            stickman_rect.y=300
            win.blit(stickman_skate,(stickman_rect.x,stickman_rect.y))
        else:
    ...
    #   left move
        ...
        if key_pressed[pygame.K_SPACE] and stickman_rect.x<1020:
            ...
            if (stickman_rect.x>1020 and stickman_rect.y==300) or (stickman_rect.x<500 and stickman_rect.x>340 and stickman_rect.y==0):
                ...
                stickman_rect.y += stickman_jump_height
        elif (stickman_rect.x+stickman_width<1020 and stickman_rect.y==300) or ((stickman_rect.x+stickman_width<340 or stickman_rect.x>500) and stickman_rect.y<100):
            stickman_rect.y+=stickman_jump_height
            win.blit(stickman_left_skate, (stickman_rect.x, stickman_rect.y))
        elif stickman_rect.x>800 and stickman_rect.x+stickman_width<930 and stickman_rect.y==100:
            stickman_rect.x-=stickman_vel
            stickman_rect.y=300
            win.blit(stickman_left_skate,(stickman_rect.x,stickman_rect.y))
        elif not((stickman_rect.x<500 and stickman_rect.x>340) and (stickman_rect.y>90 and stickman_rect.y<200)):
            stickman_rect.x-=stickman_vel
            win.blit(stickman_left_skate,(stickman_rect.x,stickman_rect.y))
    ...
    #   Standing Code
        ...
        if stickman_rect.y >= 300 and stickman_rect.x>1020 and  key_pressed[pygame.K_UP]:
                stickman_rect.x = 380
                stickman_rect.y = 0
        elif stickman_rect.y >= 0 and stickman_rect.y < 100 and stickman_rect.x>340 and stickman_rect.x<500 and key_pressed[pygame.K_DOWN]:
